...
We will see the mathematical model, how to calculate the data we need ($\theta_{max}$ and period) using raw data obtained by the accelerometer and how to filter raw data.
...
%say about problems due to offset
