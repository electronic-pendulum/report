...
At this step, the experiment is more or less resembles the final one, except for the fact that values displayed on the computer is the angle $\theta_{max}$ coupled with the period. \\
...
\textbf{Please make sure you explicitly cite the tables.
